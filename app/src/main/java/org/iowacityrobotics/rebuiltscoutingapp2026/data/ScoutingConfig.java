...
public class ScoutingConfig {
    ...
    static {
        ...
        INPUTS.add(new Field(R.id.autoPassedFuel, DataKeys.AUTO_PASSED_FUEL, DataType.TEXT));

        INPUTS.add(new Field(R.id.fuelScoredBar, DataKeys.FUEL_SCORED, DataType.NUMBER));
        INPUTS.add(new Field(R.id.shootingAccuracyBar, DataKeys.SHOOTING_ACCURACY, DataType.NUMBER));
