...
public class DataEntryDay3 extends AppCompatActivity {
    ...
    private void loadHeaderData() {
        if (getIntent() != null) {
            ...
            teamNumView.setText(getIntent().getStringExtra("PASS_TEAM_NUMBER"));
            updateAssignment();
        }
    }
    ...
    private void setupAutoFill() {
        matchNumView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) { updateAssignment(); }
